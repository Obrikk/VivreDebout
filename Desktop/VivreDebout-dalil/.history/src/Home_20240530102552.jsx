    ...
    return ( 
        <>
            ...
            <div className="home">
                ...
                >
                    <Heading 
                        fontSize={{lg:'70px',xl: '105px'}} pos={'relative'} right={{lg:'5rem', xl:'5rem'}} bottom={{base:'0rem', sm :'0rem', lg:'5rem', }} 
                    >Vivre</Heading>

                    <Heading fontSize={{lg:'90px', xl:'90px'}} pos='relative' left={{ lg:'10rem'}} bottom={{md:'3rem', lg:'7rem'}} >Debout</Heading>
