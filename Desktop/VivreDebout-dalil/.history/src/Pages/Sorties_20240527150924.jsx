...
function Sorties() {
   ...
   const handleSubmit = async()=> {
        try{
            ...
            if(!response.ok){
                throw new Error('Erreur lors de lenvoi des données')
            }
            ...
            console.error('Erreur lors de lenvoi des données : ', error.message)
        }
   }
    ...
    return ( 
      ...
      <Drawer isOpen={isOpen} onClose={onClose}>
        ...
        <DrawerContent>
          ...
          <DrawerBody  >
            ...
            >
                ...
                <Menu>
                    ...
                    <MenuList>
                        <MenuItem>Sportif</MenuItem>
                        <MenuItem>Extérieures</MenuItem>
                        <MenuItem>Musique</MenuItem>
                        <MenuItem>Théâtre</MenuItem>
                        <MenuItem>Expos</MenuItem>
                        <MenuItem>Touristique</MenuItem>
                        <MenuItem>Intra VivreDebout</MenuItem>
                    </MenuList>
                </Menu>
          ...
          <DrawerFooter>
            <Button type='submit' form='my-form' onClick={()=>window.location.reload()}>
              Ajouter
            </Button>
          </DrawerFooter>
        </DrawerContent>
