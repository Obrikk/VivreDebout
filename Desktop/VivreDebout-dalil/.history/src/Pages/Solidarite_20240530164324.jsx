...
function Solidarite() {
    ...
    return ( 
        <>
            ...
            <Header></Header>
            <Grid templateColumns={{lg:'auto', xl:'1fr 1fr 1fr'}} templateRows={{lg:'auto'}}>
                <GridItem width='100%' height='100%' minHeight={{lg:''}} display={'flex'} justifyContent={'center'} alignItems={'center'}>
                    <Flex  
                        as={motion.div}
                        width={'80%'} 
                        height={'80%'}    
