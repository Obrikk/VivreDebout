...
<Button colorScheme="blue" mr={3} onClick={() => handleRedirect('/Pch')}>
Pch
</Button>
<Button colorScheme="blue" mr={3} onClick={() => handleRedirect('Instruction')}>
Instructions
</Button>
<Button colorScheme="blue" mr={3} onClick={() => handleRedirect('Emulation')}>
Emulation
</Button>
...
const modal1Content = {
header: "Conseils",
body: "Ce sont les conseils pour ...",
};

const modal2Content = {
header: "Actions Solidaires",
body: "Ce sont les actions solidaires pour ...",
};
