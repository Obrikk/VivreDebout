    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent  borderRadius="15px" overflow="hidden" display="flex" flexDirection="column" alignItems="center" justifyContent="center" textAlign="center" position="fixed" height="85vh" backgroundColor="#FFF0F5">
        ...
        <ModalFooter  display={'flex'} gap={"10px"}>
          {currentIndex > 0 && (
            <Button padding={{base:"30px 30px",sm:"30px 40px"}} onClick={handlePrev} color="white" backgroundColor="#AB87FF" _hover={{ bg: "#9260CC" }} >
              Précédent
            </Button>
          )}

{currentIndex <10 && (
            <Button padding={{base:"30px 30px" ,sm:"30px 40px"}}onClick={handleNext} color="white" backgroundColor="#AB87FF" _hover={{ bg: "#9260CC" }}>
              Suivant
            </Button>
          )}
          <Button padding={{base:"30px 30px" ,sm:"30px 40px"}}  onClick={onClose} color="white" _hover={{ bg: "#AB87FF" }} backgroundColor="#AB87BF">
              Fermer
            </Button>
        </ModalFooter>
      </ModalContent>
