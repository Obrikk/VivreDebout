    ...
    return ( 
        <>
            ...
            <div className="home">
                ...
                >
                    <Heading 
                        fontSize={{lg:'80px',xl: '105px'}} pos={'relative'} right={{lg:'5rem', xl:'5rem'}} bottom={{base:'0rem', sm :'0rem', lg:'5rem', }} 
                    >Vivre</Heading>

                    <Heading fontSize={{lg:'90px', xl:'90px'}} pos='relative' left={{md:'5rem', lg:'11rem'}} bottom={{md:'3rem', lg:'14rem'}} >Debout</Heading>
