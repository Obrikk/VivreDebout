...
function Actus() {
    ...
    async function getUsers(){
        try{
            ...
            console.log('Type de usersData:', Array.isArray(usersData));
            console.log('Utilisateurs récupérés avec succès:', usersData);
            // Maintenant que vous avez les utilisateurs, vous pouvez faire quelque chose avec eux, par exemple les stocker dans un état local ou les afficher dans votre interface utilisateur.
            setUsers(usersData)
        } catch (error) {
