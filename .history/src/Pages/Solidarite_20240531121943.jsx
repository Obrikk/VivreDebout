...
import { Flex, Box, Grid, GridItem, Heading, Text, Button, UnorderedList, ListItem, Link, useDisclosure, Modal } from '@chakra-ui/react'
...
function Solidarite() {
    ...
    return ( 
        <>
            ...
            <Header></Header>
            <Grid templateColumns={{md:'1fr 1fr',lg:'1fr 1fr 1fr', xl:'1fr 1fr 1fr'}} templateRows={{lg:'auto', xl:'auto'}} overflow={{lg:'scroll',xl:'hidden'}} >
                <GridItem  width='100%'  display={'flex'} justifyContent={'center'} alignItems={'center'}>
                    <Flex  
                        ...
                        >
                            ...
                            <Text marginTop={'3rem'}>- Nous apportons les conseils pour le respect de l'éthique citoyenne</Text>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            ...
            <Button variant='ghost'>Secondary Action</Button>
                ...
                <GridItem width='100%' height='100%' display={'flex'} justifyContent={'center'} alignItems={'center'} gridColumnStart={{md:'1',lg:'' xl:'3'}}
                        gridColumnEnd={{md:'3',xl:'3'}} >
                    <Flex  
                        as={motion.div}
                        width={'80%'} 
                        height={'80%'}    
