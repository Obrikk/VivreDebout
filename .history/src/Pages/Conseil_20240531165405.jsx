    ...
    return ( 
        <>
            ...
            <Grid gridTemplateColumns={{lg:'1fr 1fr 1fr 1fr 1fr'}} gridTemplateRows={{lg:'1fr 1fr 1fr 1fr 1fr'}}>
                <GridItem display={} gridArea={{lg:'2 / 2 / 2 / 2'}}>
                ...
                <GridItem display={} gridArea={{lg:'4 / 2 / 4 / 2'}}>
                    <Flex as={motion.div}
                                width={'80%'} 
                                height={{lg:'60%'}}    
                                boxShadow={'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;'}
                ...
                <GridItem display={} gridArea={{lg:'3 / 3 / 3 / 3'}}>
                    <Flex as={motion.div}
                                width={'80%'} 
                                height={{lg:'60%'}}    
                                boxShadow={'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;'}
                ...
                <GridItem display={} gridArea={{lg:'2 / 4 / 2 / 4'}}>
                <Flex as={motion.div}
                            width={'80%'} 
                            height={{lg:'60%'}}    
                            boxShadow={'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;'}
                ...
                <GridItem display={} gridArea={{lg:'4 / 4 / 4 /4'}}>
