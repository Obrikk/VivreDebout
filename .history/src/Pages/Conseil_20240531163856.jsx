    ...
    return ( 
        <>
            ...
            <Grid gridTemplateColumns={{lg:'1fr 1fr 1fr 1fr'}} gridTemplateRows={{lg:'1fr 1fr 1fr 1fr 1fr'}}>
                <Flex just gridArea={{lg:'2 / 2 / 2 / 2'}}> oui</Flex>
                <Flex just gridArea={{lg:'4 / 2 / 4 / 2'}}> oui</Flex>
                <Flex just gridArea={{lg:'3 / 3 / 3 / 3'}}> oui</Flex>
                <Flex just gridArea={{lg:'2 / 4 / 2 / 4'}}> oui</Flex>
                <Flex just gridArea={{lg:'4 / 4 / 4 / 4'}}> oui</Flex>
            </Grid>
