    ...
    return ( 
        <>
            ...
            <Grid templateColumns={{lg:'1fr 1fr', xl:'1fr 1fr 1fr'}} templateRows={{lg:'auto', xl:'auto'}} overflow={{lg:'scroll',xl:'hidden'}} >
                <GridItem bg='red' width='100%'  display={'flex'} justifyContent={'center'} alignItems={'center'}>
                    <Flex  
                        as={motion.div}
                        width={'80%'} 
                        height={{lg:'80%',xl:'80%'}}    
                ...
                <GridItem width='100%' height='100%' display={'flex'} justifyContent={'center'} alignItems={'center'} gridColumnStart={{lg:'1', xl:''}}
                        gridColumnEnd={{lg:'3'}}>
                    <Flex  
                        as={motion.div}
                        width={'80%'} 
