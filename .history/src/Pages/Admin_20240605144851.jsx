...
function Admin() {
    ...
    const apiUrl = 'http://51.77.137.87'
    ...
    return ( 
        ...
        <>
            ...
            <Flex  w={'100%'}direction={'column'} >
                <Heading w={'100%'} display={'Flex'} justifyContent={'center'}>Pageee administration</Heading>
                ...
                <Text>{token &&(
                    <>
                        <p>Connecté en tant que: {jwtDecode(token).role}</p>
                    </>
                )}</Text>
