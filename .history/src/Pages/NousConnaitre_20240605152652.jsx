            ...
            <div className="nous-connaitre">
                ...
                <div className="right">
                    <form action="POST" onSubmit={sendMessage}>
                        ...
                        <input type="nomPrenom" placeholder='Jean Dujardin...' name='nomPrenom' value={message.nomPrenom} onChange={handleChange}/>

                        <label htmlFor="tel">Téléphone</label>
                        <input type="tel" placeholder='0847384093...' name= value={message.tel} onChange={handleChange} />
