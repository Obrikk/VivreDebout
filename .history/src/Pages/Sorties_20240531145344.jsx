    ...
    return (
        <>
            ...
            <div className='sorties'>
                <Heading size={{lg:'2xl'}} margin={{lg:'1rem'}} textShadow='rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;' >Sorties</Heading>
                ...
                <Button onClick={onOpen} position='absolute' top={{lg:'8rem'}} right={{lg:'10rem'}}>Ajouter une sortie</Button>
