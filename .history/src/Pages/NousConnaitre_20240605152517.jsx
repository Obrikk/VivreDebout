...
function NousConnaitre() {
    ...
    const sendMessage = (e)=> {
        e.preventDefault()
        fetch('http://localhost:8888/send',{
            method:'POST',
            headers: {
            ...
            <div className="nous-connaitre">
                ...
                <div className="right">
                    <form action="POST" onSubmit={sendMessage}>
                        ...
                        <input type="nomPrenom" placeholder='Jean Dujardin...'  value={message.nomPrenom} onChange={handleChange}/>

                        <label htmlFor="tel">Téléphone</label>
                        <input type="tel" placeholder='0847384093...' value={message.nomPrenom} onChange={handleChange} />

                        <label htmlFor="msg">Message</label>
                        <textarea name="msg" id="" value={message.nomPrenom} onChange={handleChange}></textarea>
